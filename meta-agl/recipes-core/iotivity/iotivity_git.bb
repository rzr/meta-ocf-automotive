...
SRCREV = "sandbox/pcoval/on/master/jethro"
TINYCBOR_SRCREV = "8f73a36aaf6066ac195fb3f1c5151dd83165d7a3"
...
SRC_URI[tinycbor.md5sum] = "d2ed0f569de4ef8e8da7e34ffa0d383b"
SRC_URI[tinycbor.sha256sum] = "b2242b2f14685237b9c38ed2b138b44bdab7f8d039887a33ba38396119416495"
...
do_compile_prepend() {
    ...
    if [ ! -d "${S}/extlibs/hippomocks-master/" ]; then
        cp -rf ${WORKDIR}/hippomocks-2f40aa11e31499432283b67f9d3449a3cd7b9c4d ${S}/extlibs/hippomocks-master
    fi
...
do_install() {
    ...
    copy_file ${S}/out/yocto/${IOTIVITY_TARGET_ARCH}/release/resource/csdk/stack/samples/linux/secure/*.json ${IOTIVITY_BIN_DIR_D}/examples/resource/c/secure
